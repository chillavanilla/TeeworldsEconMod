...
log "[register]: chose 'master2.teeworlds.com' as master, sending heartbeats"
log "[server]: player is ready. ClientID=0 addr=172.20.10.9:52244"
log "[game]: Teams are balanced (red=1 blue=0)"
log "[server]: player has entered the game. ClientID=0 addr=172.20.10.9:52244"
log "[game]: team_join player='0:nameless tee' team=0"
log "[server]: player is ready. ClientID=1 addr=172.20.10.9:54272"
log "[game]: start match type='CTF' teamplay='1'"
log "[game]: Teams are balanced (red=1 blue=1)"
log "[server]: player has entered the game. ClientID=1 addr=172.20.10.9:54272"
log "[game]: team_join player='1:nameless tX' team=1"
log "[game]: pickup player='0:nameless tee' item=1"
log "[game]: pickup player='0:nameless tee' item=1"
log "[game]: pickup player='0:nameless tee' item=1"
log "[game]: pickup player='0:nameless tee' item=2"
log "[game]: pickup player='0:nameless tee' item=0"
log "[game]: pickup player='0:nameless tee' item=1"
...
log "[game]: pickup player='0:nameless tee' item=1"
log "[game]: pickup player='0:nameless tee' item=1"
log "[game]: kill killer='0:0:nameless tee' victim='1:1:nameless tX' weapon=3 special=0"
log "[game]: kill killer='0:0:nameless tee' victim='1:1:nameless tX' weapon=0 special=0"
log "[server]: client dropped. cid=0 addr=172.20.10.9:52244 reason=''"
log "[game]: kill killer='0:0:nameless tee' victim='0:0:nameless tee' weapon=-3 special=0"
log "[game]: leave player='0:nameless tee'"
log "[game]: Teams are balanced (red=0 blue=1)"
log "[server]: client dropped. cid=1 addr=172.20.10.9:54272 reason=''"
log "[game]: kill killer='1:1:nameless tX' victim='1:1:nameless tX' weapon=-3 special=0"
log "[game]: leave player='1:nameless tX'"
